...
<DIV class=body_header>
    ...
    <DIV class=shortcut-buttons-set style="MARGIN-RIGHT: 40px">
        <a href="userLogout" onclick="return logoutsys();">
    ...
    <DIV id=profile-links>
        <DIV id=usertip>当前用户: ${sessionScope.user.username}</DIV>
        <DIV id=smstip>
            <div style="display:block;">所在部门: ${sessionScope.user.depname}<SPAN id=remainpoint></SPAN></div>
        </DIV>
    </DIV>
</DIV>
<DIV id=body-wrapper>
    <DIV id=left>
        ...
        <DIV id=menubg>
            <IFRAME id=leftFrame name=leftFrame src="left.jsp" frameBorder=0
    ...
    <DIV id=main>
        <IFRAME id=mainFrame
                style="BORDER-RIGHT: #c0dcf2 1px solid; BORDER-TOP: #c0dcf2 1px solid; BORDER-LEFT: #c0dcf2 1px solid; BORDER-BOTTOM: #c0dcf2 1px solid"
                name=mainFrame src="right.jsp" frameBorder=0 onload="Javascript:SetCwinHeight('mainFrame')"></IFRAME>
    </DIV>
</DIV>
...
<DIV id=bottom-tip>
    ...
    <DIV style="BACKGROUND: url(pics/buttonright.jpg) no-repeat; FLOAT: right; WIDTH: 140px">版本号:V2017</DIV>
</DIV>
