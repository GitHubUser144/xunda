        ...
        <div class="tab-content default-tab" id="form">
            <div>
                <table style="width: 100%;" border="0" cellpadding="0"
                                    ...
                                    <td width="20%" align="right">
                                        <div align="center">
                                            <img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;<a
                                                href='${pageContext.request.contextPath}/cardetailAddPage'>新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;<a
                                ...
                                <c:forEach items="${carDetail}" var="car" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid" align="center">
                                            <a href="">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="" onclick="return confirm('删除确认')">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                    ...
                    <tr>
                        <td colspan="2"><a
                                href="${pageContext.request.contextPath}/getCardetail">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getCardetail?pn=${pages.pageNum-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getCardetail?pn=${pages.pageNum+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getCardetail?pn=${pages.pages}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
