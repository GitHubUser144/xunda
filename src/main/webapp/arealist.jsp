        ...
        <div class="tab-content default-tab" id="form">
            <div>
                <table style="width: 100%;" border="0" cellpadding="0"
                                    ...
                                    <td width="20%" align="right">
                                        <div align="center">
                                            <img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;<a
                                                href='${pageContext.request.contextPath}/areaAddPage'>新增</a>&nbsp;&nbsp;&nbsp;&nbsp; <img
                            ...
                            <table width="70%" border="0" align="left" cellpadding="2"
                                ...
                                <c:forEach items="${areas}" var="area">
                                    <tr>
                                        <td width="130" height="30" class="STYLE1" nowrap="nowrap"
                                            style="BORDER: #c1dad7 1px solid">
                                            <div align="center">${area.areaid }</div>
                                        </td>
                                        <td class="STYLE1" style="BORDER: #c1dad7 1px solid">
                                            <div
                                                    align="center">${area.areaname}</div>
                                        </td>
                                        <td class="STYLE1" style="BORDER: #c1dad7 1px solid">
                                            <div
                                                    align="center">
                                                <a
                                                        href="${pageContext.request.contextPath}/areaUpdatePage?areaid=${area.areaid}&pn=${pages.pageNum}">修改</a>&nbsp;&nbsp;
                                                <a
                                                        href="${pageContext.request.contextPath}/areaDelete?areaid=${area.areaid}&pn=${pages.pageNum}"
                    ...
                    <tr>
                        <td colspan="2"><a
                                href="${pageContext.request.contextPath}/getArea">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getArea?pn=${pages.pageNum-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getArea?pn=${pages.pageNum+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a
                                    href="${pageContext.request.contextPath}/getArea?pn=${pages.pages}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
