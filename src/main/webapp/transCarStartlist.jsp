...
<div id="maintitle">
    <div id="mainico"></div>
    <div id="maintip"><strong>位置：</strong>未发车信息列表</div>
</div>
        ...
        <div class="tab-content default-tab" id="form">
            <div>
                <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <c:forEach items="${cars}" var="car" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid"
                                            ...
                                            <a href="${pageContext.request.contextPath}/transCarUpdateCarStuaus?transid=${car.transid}&status=0">发车</a>&nbsp;&nbsp;
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/getTransCarStatus?statusid=0">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCarStatus?statusid=0&pn=${pages.pageNum-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCarStatus?statusid=0&pn=${pages.pageNum+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCarStatus?statusid=0&pn=${pages.pages}t">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            第${pages.pageNum }页&nbsp;&nbsp;&nbsp;&nbsp;
                            共${pages.pages }页&nbsp;&nbsp;&nbsp;&nbsp;
                            未出发的共${pages.total }趟车&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </div>
