            ...
            <TR>
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center width=85><A
                                                    href="${pageContext.request.contextPath}/getCardetail">订单管理</A>
                                            </TD>
                                        </TR>
                                        <TR>
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center align=left width=85><A
                                                    href="${pageContext.request.contextPath}/getTransCar">运输管理</A>
                                            </TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center width=85><A
                                                    href="${pageContext.request.contextPath}/getCustomer">客户管理</A>
                                            </TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center align=left width="50%" height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center width=85><A
                                                    href="${pageContext.request.contextPath}/userAddPage">添加用户</A></TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center align=left width=85><A
                                                    href="${pageContext.request.contextPath}/getCar">运输工具管理</A></TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center align=left width="50%" height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center width=85><A
                                                    href="${pageContext.request.contextPath}/getCustomerRep">财务管理</A></TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center align=left width="50%" height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center align=left width=85><A
                                                    href="${pageContext.request.contextPath}/getTransCarStatus?statusid=0">未发车情况</A>
                                            </TD>
                                        </TR>
                                        <TR>
                                ...
                                <TD vAlign=center align=left width="50%" height=70>
                                    <TABLE cellSpacing=0 cellPadding=0 width=160>
                                        ...
                                        <TR>
                                            ...
                                            <TD vAlign=center align=left width=85><A
                                                    href="${pageContext.request.contextPath}/getTransCarStatus?statusid=2">已到站情况</A>
                                            </TD>
                                        </TR>
                                        <TR>
                ...
                <TD vAlign=top width="40%">
                    ...
                    <DIV class=newborder style="MARGIN-RIGHT: 0px">
                        <img src="images/map.jpg" / width="440" border="0">
                        <DIV
                                class=DivNotice></DIV>
                    </DIV>
                </TD>
