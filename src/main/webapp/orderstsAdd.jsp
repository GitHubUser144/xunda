...
<div id="maintitle">
    <div id="mainico"></div>
    <div id="maintip"><strong>位置：</strong>订单状态设置</div>
</div>
                ...
                <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <form action="${pageContext.request.contextPath}/orderstatusAdd" method="post"
                                ...
                                <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1">
                                    <tr>
                                        ...
                                        <td class="STYLE1" style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="ordername">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="130" height="30" class="STYLE1" nowrap="nowrap"
