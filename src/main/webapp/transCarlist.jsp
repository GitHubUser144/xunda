        ...
        <div class="tab-content default-tab" id="form">
            <div>
                <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <td style="BORDER-BOTTOM: #c1dad7 1px solid">
                            <table style="width:100%;height:55px;" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="70%">
                                        <p class="left_txt2">运输车辆资料列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font
                                                color="red">${delErrror }</p>
                                    </td>
                                    <td width="20%" align="right">
                                        <div align="center">
                                            <img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;<a
                                                href='${pageContext.request.contextPath}/addTracsCarPage'>新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;<a
                                ...
                                <c:forEach items="${cars}" var="car" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="STYLE1" nowrap="nowrap" style="BORDER: #c1dad7 1px solid"
                                            ...
                                            <a href="${pageContext.request.contextPath}/transCarUpdatePage?transId=${car.transid }&pn=${pages.pageNum}">修改</a>&nbsp;&nbsp;
                                            <a href="./TransCarServlet?action=del&currPage=1&opr=first&transId=${car.transid }"
                                               onclick="return testDel(); ">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/getTransCar">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCar?pn=${pages.pageNum-1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCar?pn=${pages.pageNum+1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/getTransCar?pn=${pages.pages}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            第${pages.pageNum }页&nbsp;&nbsp;&nbsp;&nbsp;
                            共${pages.pages }页&nbsp;&nbsp;&nbsp;&nbsp;
                            共${pages.total }趟车&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
